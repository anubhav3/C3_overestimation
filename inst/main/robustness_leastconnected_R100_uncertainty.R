# 2022.07.04
# We investigate how the robustness (R100: the number of species required to achieve a total loss of all the species) vary across food webs for least connected extinction scenario
...
dd_lc <- readRDS("results/least_connnected_uncertainty_new.RDS")
...
# saveRDS(object = rob_all, file = "results/robustness_R100_leastconnected_uncertainty.RDS")
