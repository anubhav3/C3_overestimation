...
dd <- readRDS("results/robustness_R50_mostconnected_uncertainty.RDS")
...
dd <- readRDS("results/robustness_R50_random_uncertainty.RDS")
...
dd <- readRDS("results/robustness_R50_leastconnected_uncertainty.RDS")
...
plot_R50_slope <- annotate_figure(plot_R50_slope, bottom = 
                  text_grob(expression(paste(frac(paste("Relative difference in robustness ", (R[50])), "Relative difference in connectance"))),
                            hjust = 0.05))
