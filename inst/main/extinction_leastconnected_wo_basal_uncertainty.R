# 2022.07.22
# We simulated primary extinction by removing least connected species in all the 1000 food web predicted by the ADBM 
...
# saveRDS(object = dd_lc, file = "results/least_connnected_wo_basal_uncertainty.RDS")
