...
dd_lc <- readRDS("results/least_connected_wo_basal_maxTSS.RDS")
...
# ggsave(plot = plot_dd_lc_mod, filename = "results/plot_leastconnected_wo_basal_maxTSS.png", width = 13, height = 6)
