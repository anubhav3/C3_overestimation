# 2022.08.03
# We simulated primary extinction by removing species with max generality in food web predicted by the ADBM which had the maximum TSS
...
for(i in fw_ind){
  ...
  dd_mg <- rbind(data.frame(n_ext = real_ext_mc$acc_pri_ext,
...
# saveRDS(object = dd_mg, file = "results/maxgenerality_maxTSS.RDS")
