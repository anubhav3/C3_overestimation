...
dd_mg <- readRDS("results/maxgenerality_maxTSS.RDS")
...
plot_dd_mg_mod <- ggplot(dd_mg_mod) +
...
# ggsave(plot = plot_dd_mg_mod, filename = "results/plot_maxgenerality_maxTSS.png", width = 13, height = 6)
