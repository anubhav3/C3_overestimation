...
dd <- readRDS("results/robustness_R50_mostconnected_wo_basal_uncertainty.RDS")
...
dd <- readRDS("results/robustness_R50_wo_basal_random_uncertainty_120.RDS")
...
dd <- readRDS("results/robustness_R50_leastconnected_wo_basal_uncertainty.RDS")
...
# ggsave(plot = plot_R50_slope, filename = "results/plot_R50_wo_basal_slope.png", width = 15, height = 6)
