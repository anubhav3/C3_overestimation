...
dd_rand_raw <- readRDS("results/random_raw_minTSS.RDS")
...
# saveRDS(object = rob_all, file = "results/OP_2022_08_10/robustness_ra_min_TSS.RDS")


#### Median ####

rob_all_smry_median <- rob_all %>%
...
rob_ra_minTSS_median <- rob_all_smry_median %>%
...
# ggsave(plot = rob_ra_minTSS_median, filename = "results/OP_2022_08_10/plot_rob_ra_minTSS_median.png")
...
rob_ra_minTSS_mean <- rob_all_smry_mean %>%
...
# ggsave(plot = rob_ra_minTSS_mean, filename = "results/OP_2022_08_10/plot_rob_ra_minTSS_mean.png")
