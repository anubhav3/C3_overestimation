# 2022.08.02
# Simulating extinction of species with most abundance

mostabundant_ext <- function(net, bodysize){
  ...
  while(all(is.na(new_net)) == FALSE){
    ...
    ## Using the body mass abundance scaling
    ## Largest body size has the lowest abundance
    node <- names(which.min(bodysize))
