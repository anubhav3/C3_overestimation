...
dd_mc <- readRDS("results/most_connected.RDS")
...
# saveRDS(object = rob_all, file = "results/robustness_mostconnected.RDS")

# rob_all <- readRDS(file = "results/robustness_mostconnected.RDS")
...
# saveRDS(object = plot_rob_all, file = "results/ggplot_rob_mostconnected.RDS")


# ggsave(plot = plot_rob_all, filename = "results/plot_robustness_mostconnected.png", width = 11, height = 6)
